...
export const DATA = {
  ...
  contact: {
    email: "anupamk.krishnan@gail.com",
    tel: "+91 9162330447",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/anupam-kumar-krishnan",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/anupamkumarkrishnan/",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://x.com/krishnan_anupam",
        icon: Icons.x,
  ...
  education: [
    {
      ...
      degree: "Bachelor of Engieering, Computer",
      logoUrl: "/dyp.jpg",
      description:
        "Did my Engineering in Computer from D. Y. Patil College of Engineering, Pune with 8.7 CGPA ",
      start: "2018",
      end: "2022",
    },
  ],
